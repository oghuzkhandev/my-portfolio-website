...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 relative overflow-hidden" ref={ref}>
      ...
      <motion.div
        className="absolute top-20 -left-20 w-96 h-96 bg-fuchsia-500/20 rounded-full blur-3xl"
        style={{ y }}
      />
      <motion.div
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="w-28 h-1 bg-gradient-to-r from-fuchsia-500 via-cyan-400 to-emerald-400 mx-auto mb-20 rounded-full shadow-lg" />
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-3xl font-bold mb-8 bg-gradient-to-r from-fuchsia-400 to-cyan-400 bg-clip-text text-transparent">
              Transforming Ideas into Luxury Digital Experiences
            </h3>
            <div className="space-y-6 text-muted-foreground">
              <p className="text-lg leading-relaxed">
                ...
                , I craft seamless, premium web applications that drive real
                business impact.
              </p>
              <p className="text-lg leading-relaxed">
                From designing{" "}
                ...
                , I deliver solutions for startups and enterprises, scaling
                ideas into digital empires.
              </p>
              <p className="text-lg leading-relaxed">
                Passionate about{" "}
                <Badge variant="glow" className="mx-1 text-sm px-2.5 py-0.5">
                ...
                with modern DevOps, I stay ahead of trends to create experiences
                that feel truly next-gen.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 mt-12">
              {stats.map((stat, index) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-white/10 to-transparent rounded-xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  <div className="relative p-6 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-fuchsia-400/50 shadow-lg hover:shadow-fuchsia-500/30 transition-all duration-500">
          ...
          >
            <div className="flex justify-center mb-12">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <AnimatedTooltip items={achievements} />
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              {values.map((value, index) => (
                ...
                >
                  ...
                  />
                  <div className="relative p-6 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-fuchsia-400/50 shadow-md hover:shadow-fuchsia-500/30 transition-all duration-500">
                    <div className="flex items-start gap-4">
                      <div
                        className={`p-3 rounded-xl bg-gradient-to-r ${value.color} shadow-md flex-shrink-0`}
                      >
                        <value.icon className="w-6 h-6 text-white" />
                      </div>
                      <div>
                        <h4
                          className={`font-bold text-xl mb-2 bg-gradient-to-r ${value.color} bg-clip-text text-transparent`}
                        >
                          {value.title}
                        </h4>
            ...
            >
              ...
              →{" "}
              <Button
                className="relative px-8 py-3 rounded-lg font-bold text-white text-[15px]
